...
class DropDownPreference(
    ...
    defStyleAttr: Int,
    defStyleRes: Int
) : androidx.preference.DropDownPreference(context, attrs, defStyleAttr, defStyleRes) {
    ...
    override fun persistString(value: String?): Boolean =
        when (persistType) {
            PersistType.Boolean -> throw IllegalStateException("DropDownPreference was not supported Boolean persist type.")
            ...
            PersistType.Set -> throw IllegalStateException("DropDownPreference was not supported Set persist type.")
        }
